...
if(isset($_POST['bsubmit']))
{
    ...
    $feedback = $_POST['feedback'];
     ...
     $query = "INSERT INTO feedback (name,email,date,feedback) VALUES ('$name','$email','$date','$feedback')";
            ...
            if($query_run)
            {
                echo "<script>window.location.href='inventory-details-cars.php';</script>";
				exit;
            }
            else 
            {
            ...
            <section class="breadcrumb-area breadcrumb-bg inventory-details-breadcrumb" data-background="img/bg/breadcrumb_bg.jpg">
                <div class="container">
                    <div class="row">
                             ...
                             include('config.php');
								$ii=$_GET['itemno'];
								$query = "SELECT * FROM car_list where car_id=$ii";
								$query_run = mysqli_query($connection, $query);
                    ...
                    <div class="row no-gutters inv-details-active">
                        ...
                        <div class="col-lg-12">
                            <div class="inv-details-slide-item">
                                <img src="<?php echo 'img/car/'.$row['image'];?>" width="100%" height="700px" alt="">
                            </div>
                        </div>
...
<br>                            
                                    <div class="product-rating float-left">
                                                ...
                                                ?>
                                                            ...
                                                            <?php }}?>
                                             <a href="#" class="inv-details-title">(<?php 
                                                    include('config.php');
